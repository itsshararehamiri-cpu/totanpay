...
fun NavGraphBuilder.purchaseNavigation(
    ...
    navigation(
        route = "purchase_navigation?amount={amount}&purchaseId={purchaseId}&packageName={packageName}",
        startDestination = "read_card",
        arguments = listOf(
            navArgument("amount") {
        ...
        composable(route = "read_card?amount={amount}&purchaseId={purchaseId}&packageName={packageName}") { backStack ->
            ...
            ReadCardScreen(viewModel = hiltViewModel(),amount=amount,
                operator = null,
        ...
        composable(
            route = "get_pin?amount={amount}&purchaseId={purchaseId}&track2={track2}&packageName={packageName}" ,arguments = listOf(
                navArgument("amount") {
                    type = NavType.StringType
                    nullable = false
                },
        ...
        composable(
            route = "loading?amount={amount}&purchaseId={purchaseId}&track2={track2}&pinBlock={pinBlock}&packageName={packageName}",
            arguments = listOf(
                navArgument("amount") {
                    type = NavType.StringType
                    nullable = false
        ...
        composable(
            route = "purchase_success_result?response={response}&packageName={packageName}",
            arguments = listOf(
...
sealed class PurchaseRoutes(val route:String){
    class Start(val amount:String,val purchaseId:String?,val packageName:String?): PurchaseRoutes("purchase_navigation?amount=$amount&purchaseId=$purchaseId&packageName=$packageName")
}
