...
@HiltViewModel
class PurchaseViewModel @Inject constructor(private val mainRepository: MainRepository) :
    ViewModel() {
    private val _uiState = MutableStateFlow(PurchaseUiState())
    val uiState: StateFlow<PurchaseUiState> = _uiState

    fun purchase( track2: String, amount: String, pinBlock: String) {
        viewModelScope.launch {
            val result = mainRepository.purchase(amount, track2, pinBlock)
