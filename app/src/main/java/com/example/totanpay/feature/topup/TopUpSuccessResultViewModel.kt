...
import com.example.totanpay.feature.voucher.PurchaseSuccessResultUiState
...
class TopUpSuccessResultViewModel @Inject constructor(
    ...
    private val deviceSettingsRepository: DeviceSettingsRepository,   private val deviceRepository: DeviceRepository
) :
    ViewModel() {
