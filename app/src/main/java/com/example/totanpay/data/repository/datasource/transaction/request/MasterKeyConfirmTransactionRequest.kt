...
,val hashedMasterToken:String,val terminalId:String,terminalLanguage:String,
     ...
     BaseTransactionRequest( serial=serial, appVersion=appVersion,terminalLanguage=terminalLanguage, nii=nii,stan=stan,date=date,
          time=time, posConditionCode = posConditionCode, terminalConnectionType = "")// TODO:  