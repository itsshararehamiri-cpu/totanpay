...
class TopUpRepositoryImpl @Inject constructor(
    ...
    override suspend fun topUp(
        ...
        return withContext(ioDispatcher) {
                ...
                val result = dataSource.topUp(isNetworkAvailable = {
                    ...
                    terminalConnectionType = connectionSettingsDataSource.getTerminalConnectionType().toEnglishNumber(),
                    ...
                    posConditionCode = connectionSettingsDataSource.getPosConditionCode().toEnglishNumber(),
                ...
                if (result is ResponseData.Success) {
                    ...
                    ResponseData.Success(
                        result.data!!.toTopUpSuccessResponse(
                            merchant = merchant,
