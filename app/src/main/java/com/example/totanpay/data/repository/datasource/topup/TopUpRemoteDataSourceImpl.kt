...
class TopUpRemoteDataSourceImpl @Inject constructor(private val macGenerator: IMacGenerator,
                                                    ...
                                                    private val settleReverseRemoteDataSource: SettleReverseRemoteDataSource):TopUpRemoteDataSource {
    init {
    ...
    override suspend fun topUp(
        ...
        appVersion: String,
        nii: String,
        posConditionCode: String,      logs: String?,
        ...
        if (isNetworkAvailable()) {
            ...
            val transaction = TopUpTransaction(TopUpTransactionRequest(
                ...
                mobile = mobile,
                posConditionCode = posConditionCode,logs=logs
            ),
                macGenerator,
                connection,
                saveTransactionLog = {
