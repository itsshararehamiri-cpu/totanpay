...
class BillRemoteDataSourceImpl @Inject constructor(
    ...
    override suspend fun billInquiry(
        ...
        if (isNetworkAvailable()) {
            ...
            val transaction = BillInquiryTransaction(
                BillInquiryTransactionRequest(
        ...
        if (isNetworkAvailable()) {
            ...
            val transaction = BillPayTransaction(
                ...
                deleteTransaction = { dateOfTransaction, timeOfTransaction ->
                    transactionLogDao.deleteByDateTime(dateOfTransaction, timeOfTransaction)
                },
