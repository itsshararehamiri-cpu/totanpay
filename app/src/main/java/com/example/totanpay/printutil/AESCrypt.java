...
public final class AESCrypt {
     ...
     */
    public static byte[] encrypt(byte[] password, byte[] message)
            throws GeneralSecurityException {
        try {
            final SecretKeySpec key = generateKey(bytesToHex(password));
     ...
     *
     * @param password   used to generated key
     * @param CipherText the encrpyted message
